...
public class ScrollableExpandWidget extends DrawableWidget implements SubSelectable {
    ...
    private void initBorderWidgets(){
        this.scroll = new ScrollElement(PropertyTracker.<ScrollElement, Double>event((v, b)->{
            if(hasScroll()){
                resizePose(b);
            }else {
                resizePose(0.0d);
        ...
        this.scoll = new DraggableExecutableWidget(ScrollableExpandWidget.this.x + ScrollableExpandWidget.this.dx, ScrollableExpandWidget.this.y,(int) ScrollElement. BUTTON_WIDTH, ScrollableExpandWidget.this.dy)
            .setElementHandler(this.scroll)
        ;
            this.scrollableBorder = new SubScreenWidget(ScrollableExpandWidget.this.x, ScrollableExpandWidget.this.y, ScrollableExpandWidget.this.dx, ScrollableExpandWidget.this.dy);
    }
