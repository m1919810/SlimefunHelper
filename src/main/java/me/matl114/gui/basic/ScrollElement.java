...
public class ScrollElement extends AbstractElement {
    ...
    public static ScrollElement instance(PropertyTracker<ScrollElement, Double> valueTracker, BooleanSupplier activate){
    ...
    public void renderCentered0(DrawableWidget element, VDrawContext context, int mouseX, int mouseY, float delta, float alpha, boolean shouldHighlight){
        ...
        context.drawGuiTexture(texture, (int) rendX, (int) rendY, 110, (int) (BUTTON_WIDTH * rendSize), (int) (BUTTON_HEIGHT* rendSize));
    }
