...
public class ListRegistrySelectScreen<T> extends ListSelectScreen<Triplet<String, Identifier, T>> {
    ...
    public ListRegistrySelectScreen(Registry<T> registry, Function<T, String> localization, Function<Triplet<String, Identifier, T>, RenderHandler> renderFactory, int x, int y, int dx, int dy, int height){
    ...
    public static ListRegistrySelectScreen<Item> item(int x, int y, int dx, int dy, int height){
    ...
    public static ListRegistrySelectScreen<EntityAttribute> attribute(int x, int y, int dx, int dy, int height){
        return new ListRegistrySelectScreen<>(
