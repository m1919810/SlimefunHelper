...
public abstract class MatrixStackMixin implements me.matl114.versioned.api.MatrixStack {
    ...
    @Shadow public abstract MatrixStack.Entry peek();

    @Shadow public abstract void translate(float x, float y, float z);

    @Shadow public abstract void scale(float x, float y, float z);

    @Shadow public abstract void multiply(Quaternionf quaternion);
