...
public class ReflectHelper {
    ...
    public static List<String> getClassInfo(Object what){
        ...
        return Arrays.stream(clazz.getDeclaredConstructors()).map(ReflectHelper::getMethodInfo).toList();
    }
    ...
    public static List<String> getMethodsInfo(Object what){
        ...
        return Arrays.stream(clazz.getMethods()).map(ReflectHelper::getMethodInfo).toList();
    }
    ...
    private static boolean canCastTo(Object a, Class<?> b){
        if(isPrimitiveType(b.getName())){
            ...
            return a  == null || b.isAssignableFrom(a.getClass()) || b.isAssignableFrom(getBoxedClass(a.getClass().getName()));
        } else {
