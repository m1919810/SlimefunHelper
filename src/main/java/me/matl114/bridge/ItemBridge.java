...
public class ItemBridge {
    ...
    static {
        TESTITEM = Items.register("myitem", (settings -> {
            Item item = new Item(
                settings.component(DataComponentTypes.MAX_STACK_SIZE, 11)
                    .component(DataComponentTypes.PROFILE, BukkitItemStackUtils.buildPlayerHeadProfileCSCoreLib("669c95e7451629add7845233131da5543157b8df52afadec1a586a0e549ee777"))
