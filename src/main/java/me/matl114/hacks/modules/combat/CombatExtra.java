...
public class CombatExtra extends BaseModule {
    ...
    public final FlagRef shieldAttack = flagBuilder(Configs.COMBAT_CONFIG, COMBAT_SHIELDING)
        .build();

    public final FlagRef rideAttack = flagBuilder(Configs.COMBAT_CONFIG, COMBAT_RIDING)
        .build();

    public final FlagRef noCooldown = flagBuilder(Configs.COMBAT_CONFIG, COMBAT_INTERVEL)
        .build();
    ...
    public void registerAll() {
        super.registerAll();
        registerListener(Listener.getPacketPoint().getChannel(EntityTrackerUpdateS2CPacket.class), this::onShieldSetback);
        registerListener(Listener.getPacketPostSendPoint().getChannel(HandSwingC2SPacket.class), this::onShieldSetbackPredict);
        registerListener(Listener.getPacketPoint().getChannel(CooldownUpdateS2CPacket.class), this::asyncUpdateShieldCooldown);
    }
