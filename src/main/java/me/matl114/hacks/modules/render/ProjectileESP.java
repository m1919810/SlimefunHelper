...
public class ProjectileESP extends BaseModule {
    ...
    public final FlagRef enable = flagBuilder(Configs.RENDER_CONFIG, CAL_TRACE)
        .build();

    public final FlagRef calculateFireball = flagBuilder(Configs.RENDER_CONFIG, CAL_FIREBALL_TRACE)
        .build();

    public final FlagRef calculateArrow = flagBuilder(Configs.RENDER_CONFIG, CAL_PROJECTILE_TRACE)
        .build();

    public final FlagRef renderFireball = flagBuilder(Configs.RENDER_CONFIG, RENDER_FIREBALL_TRACE)
        .build();

    public final FlagRef renderArrow = flagBuilder(Configs.RENDER_CONFIG, RENDER_PROJECTILE_TRACE)
        .build();
