...
public class MovExtra extends BaseModule {
    ...
    public final FlagRef noStepHeightFeature = flagBuilder(Configs.MOV_CONFIG, MOVE_COMPATE_HIGHER_VERSION)
        .build();

    public final FlagRef noVelocitySetback = flagBuilder(Configs.MOV_CONFIG, MOVE_DISABLE_SETBACK_VELOCITY_RESET)
        .build();
