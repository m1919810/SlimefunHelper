...
public class NoFallModule extends BaseModule implements LegalMovementManager.MovementModifier {
    ...
    public final Config.FlagRef noFall = Configs.MOV_CONFIG
        .builder(Boolean.class)
        .path(MOVE_NOFALL)
        .defaultValue(false)
        .apply(this::bindFlag)
        .build();
    public final Config.EnumRef<NofallBypassMode> noFallModel = Configs.MOV_CONFIG
        .builder(NofallBypassMode.class)
        .path(MOVE_NOFALL_MODE)
        .defaultValue(NofallBypassMode.NO_BYPASS)
        .build();

    public final Config.IntRef noFallSafeDistance = Configs.MOV_CONFIG
    ...
    public void onPlayerInit(ClientPlayerEntity player){
        initArguments();
        initDelegate();
    }
    ...
    public static abstract class NoFallDelegate implements LegalMovementManager.MovementModifier{
        ...
        public NoFallDelegate(NoFallModule module){
            this.module = module;
        }
    ...
    public static class NoFallNoBypass extends NoFallDelegate {
        ...
        public NoFallNoBypass(NoFallModule module) {
            super(module);
        }
    ...
    public static class NoFallLazy extends NoFallDelegate {
        ...
        public NoFallLazy(NoFallModule module) {
            super(module);
        }
...
//                                    entity.entity.setPos(entity.pos.getX(), entity.entity.getY() , entity.pos.getZ());
    ...
    public static class NoFallBypassGrim extends NoFallDelegate {
        ...
        int waitTimeout = 0;
        public NoFallBypassGrim(NoFallModule module) {
            super(module);
        }
...
//                        mc.getNetworkHandler().sendPacket(new PlayerMoveC2SPacket.PositionAndOnGround(player.getX(), player.getY(), player.getZ(),false));
    ...
    public static class NoFallLazyBypassGrim extends NoFallDelegate{
        ...
        public NoFallLazyBypassGrim(NoFallModule module) {
            super(module);
...
//                                    entity.entity.setPos(entity.pos.getX(), entity.entity.getY() , entity.pos.getZ());
    ...
    public static enum NofallBypassMode implements Config.ConfigEnum{
        NO_BYPASS,
        LAZY_MODE,
        BYPASS_GRIM,
