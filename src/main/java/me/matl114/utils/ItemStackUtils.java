...
public class ItemStackUtils {
    ...
    public static NbtCompound getBukkitValue(@Nonnull NbtCompound nbt) {
        return nbt.contains(BUKKIT_NAMESPACE, NbtElement.COMPOUND_TYPE)
                ? (nbt.get(BUKKIT_NAMESPACE) instanceof NbtCompound cpd ? cpd : null)
                : null;
    }
    ...
    public static String getSfIdFromBukkitValues(NbtCompound ntb) {
        return ntb == null
                ? null
                : (ntb.get(SLIMEFUN_ID_PATH) instanceof NbtString nbtString ? nbtString.asString() : null);
    }
