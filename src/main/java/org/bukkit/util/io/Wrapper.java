...
public final class Wrapper<T extends Map<String, ?> & Serializable> implements Serializable {
    ...
    public static Wrapper<ImmutableMap<String, ?>> newWrapper(@NotNull ConfigurationSerializable obj) {
        return new Wrapper<ImmutableMap<String, ?>>(ImmutableMap.<String, Object>builder().put(BukkitSerializationMock.SERIALIZED_TYPE_KEY, BukkitSerializationMock.getAlias(obj.getClass())).putAll(obj.serialize()).build());
    }
